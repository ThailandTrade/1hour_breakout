...
def london_signal_window(d: date) -> Tuple[int, int]:
    ...
    start = int((base + timedelta(hours=7)).timestamp()*1000)               # 07:00 UTC
    end   = int((base + timedelta(hours=11, minutes=45)).timestamp()*1000)  # 11:45 UTC
    return start, end
